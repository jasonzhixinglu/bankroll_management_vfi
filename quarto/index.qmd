---
title: "Optimal Bankroll Management"
author: "Jason Zhixing Lu"
date: today
format:
  html:
    toc: true
...
This document accompanies a clean Python replication of the model, written from scratch to make the logic and moving parts as transparent as possible. The goal is exposition rather than novelty — the code is structured to be read alongside the results, and the full source is available in the [repository](https://github.com/jasonzhixinglu/bankroll_management_vfi).
